...
public class MyListsPageObject extends MainPageObject {
    ...
    public void waitForArticleToAppearByTitleAndClick(String article_title) {
        ...
        String article_xpath = getFolderXpathByName(article_title);
        this.waitForElementAndClick(By.xpath(article_xpath), "Cannot find saved article by title " + article_title, 15);
    }

    public void waitForArticleToDisappearByTitle(String article_title) {

        String article_xpath = getFolderXpathByName(article_title);
        this.waitForElementNotPresent(By.xpath(article_xpath), "Saved article still present with article title " + article_title, 15);
    }
